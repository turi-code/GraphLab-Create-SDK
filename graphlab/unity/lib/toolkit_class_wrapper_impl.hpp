...
#ifndef GRAPHLAB_UNITY_TOOLKIT_CLASS_WRAPPER_IMPL_HPP
#define GRAPHLAB_UNITY_TOOLKIT_CLASS_WRAPPER_IMPL_HPP
#include <graphlab/unity/lib/toolkit_function_wrapper_impl.hpp>

namespace graphlab {
class toolkit_class_base;
namespace toolkit_class_wrapper_impl {
using graphlab::toolkit_function_wrapper_impl::generate_member_function_wrapper;
using graphlab::toolkit_function_wrapper_impl::generate_const_member_function_wrapper;
