...
#ifndef GRAPHLAB_UNITY_LIB_VARIANT_DETAIL_HPP
#define GRAPHLAB_UNITY_LIB_VARIANT_DETAIL_HPP
#include <vector>
#include <map>
...
#include <graphlab/unity/lib/unity_global_singleton.hpp>
#include <graphlab/flexible_type/flexible_type_converter.hpp>
#include <graphlab/unity/lib/api/function_closure_info.hpp>
namespace graphlab {
