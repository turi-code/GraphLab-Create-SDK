...
#include <graphlab/cppipc/ipc_object_base.hpp>
#include <graphlab/cppipc/util/generics/member_function_return_type.hpp>
#include <graphlab/cppipc/util/generics/tuple.hpp>
#include <graphlab/cppipc/server/dispatch.hpp>
#include <graphlab/cppipc/server/comm_server.hpp>
