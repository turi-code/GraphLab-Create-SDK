...
#ifndef GRAPHLAB_SERIALIZATION_DIR_ARCHIVE_HPP
#define GRAPHLAB_SERIALIZATION_DIR_ARCHIVE_HPP
#include <cstddef>
#include <vector>
#include <string>
#include <memory>
#include <map>
#include <graphlab/fileio/fs_utils.hpp>
#include <graphlab/fileio/general_fstream.hpp>
namespace graphlab {
...
class dir_archive {
 ...
 private:
  ...
  void make_s3_write_cache(const std::string& directory);
