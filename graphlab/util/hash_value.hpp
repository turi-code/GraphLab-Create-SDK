...
#ifndef GRAPHLAB_HASH_VALUE_H_
#define GRAPHLAB_HASH_VALUE_H_
 ...
 *
 */
class hash_value : public graphlab::IS_POD_TYPE {
 public:
  /**
...
template <> struct hash<graphlab::hash_value> {
  size_t operator()(const graphlab::hash_value& t) const {
